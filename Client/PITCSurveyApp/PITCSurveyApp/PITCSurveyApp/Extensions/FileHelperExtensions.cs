...
namespace PITCSurveyApp.Extensions
{
	...
	static class FileHelperExtensions
    {
		...
		public static Task SaveAsync<T>(this FileHelper fileHelper, string filename, T item)
        {
		...
		public static async Task<T> LoadAsync<T>(this FileHelper fileHelper, string filename)
        {
